...
<html>
    <head>
        ...
        <title>UnlockBase API : Examples : RetryOrder</title>
        <style type="text/css">
            <!--
            body, td {
                font-family: Arial;
    ...
    <body>
        <h1>RetryOrder</h1>
        <p>We cannot show a live example for RetryOrder, please change the source code to retry an order.</p>
        <?php
        /* Include the library */
        require('../Library/API.php');

        /* Call the API */
        $XML = UnlockBase::CallAPI('RetryOrder', array(/* Put your parameters here */));
